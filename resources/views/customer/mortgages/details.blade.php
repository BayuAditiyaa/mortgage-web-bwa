  ...
  @section('title', 'Details Mortgage page')
  @section('content')
                  ...
                  <nav class="flex flex-col gap-[40px] pb-[40px] pl-[30px]">
                      <section id="General" class="flex flex-col gap-[24px]">
                          ...
                          <ul class="flex flex-col gap-[24px]">
                              <li class="group">
                                  <a href="{{ route('dashboard.overview') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/overview-n.svg') }}" alt="icon"
                              ...
                              <li class="group">
                                  <a href="{{ route('dashboard.bank-interests') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/bank-interests-n.svg') }}" alt="icon"
                                              class="shrink-0 group-[&.active]:hidden" />
                              ...
                              <li class="group">
                                  <a href="{{ route('dashboard.rewards') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/big-rewards-n.svg') }}" alt="icon"
                                              class="shrink-0 group-[&.active]:hidden" />
                      ...
                      <section id="Others" class="flex flex-col gap-[24px]">
                          ...
                          <ul class="flex flex-col gap-[24px]">
                              <li class="group">
                                  <a href="{{ route('dashboard.help-center') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/help-center-n.svg') }}" alt="icon"
                                              class="shrink-0 group-[&.active]:hidden" />
                              ...
                              <li class="group">
                                  <a href="{{ route('dashboard.support') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/supports-n.svg') }}" alt="icon"
                                              class="shrink-0 group-[&.active]:hidden" />
                                          <p class="group-[&.active]:font-semibold group-[&.active]:text-tedja-green">
                                              Supports</p>
                                      </div>
                              ...
                              <li class="group">
                                  <a href="{{ route('dashboard.settings') }}"><div class="relative flex items-center gap-[6px]"><img src="{{ asset('assets/images/icons/settings-n.svg') }}" alt="icon"
                                              class="shrink-0 group-[&.active]:hidden" />
                                          <p class="group-[&.active]:font-semibold group-[&.active]:text-tedja-green">
                                              Settings</p>
                                      </div>
                          ...
                          <div class="flex flex-col gap-5 w-full">
                              <section id="Title" class="flex items-center justify-between">
                                  <div class="flex flex-col gap-[6px]">
                                      <h2 class="font-bold text-[20px] leading-[30px]">{{ $mortgageRequest->house->name }}
                                      </h2>
                                  ...
                                  @if ($mortgageRequest->status == 'Waiting for Bank')
                                      <span class="bg-tedja-orange rounded-full py-[6px] px-[10px] font-semibold">Waiting
                                          for Bank</span>
                                  ...
                                  @elseif ($mortgageRequest->status == 'Rejected')
                                      <span
                                          class="bg-tedja-orange rounded-full py-[6px] px-[10px] font-semibold">Rejected</span>
                                  @endif
                              </section>
                              <section id="Points" class="grid grid-cols-3 gap-x-[18px] gap-y-[12px]">
                                  <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                      ...
                                      <p class="font-semibold text-sm leading-[21px]">
                                          {{ $mortgageRequest->house->bedroom }} Bedroom</p>
                                  </div>
                                  <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                      <img src="{{ asset('assets/images/icons/building.svg') }}" alt="icon"
                                          class="shrink-0 size-5">
                                      <p class="font-semibold text-sm leading-[21px]">
                                          {{ $mortgageRequest->house->building_area }} m&sup2;</p>
                                  </div>
                                  <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                  ...
                                  <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                      <img src="{{ asset('assets/images/icons/maximize.svg') }}" alt="icon"
                                          class="shrink-0 size-5">
                                      <p class="font-semibold text-sm leading-[21px]">
                                          {{ $mortgageRequest->house->land_area }} m&sup2;</p>
                                  </div>
                                  <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                          ...
                          <div class="TabValues mt-5">
                                          ...
                                          <section id="PriceDetails"
                                              ...
                                              <div class="flex flex-col gap-4">
                                                  <div class="flex items-center justify-between">
                                                      ...
                                                      <strong
                                                          class="font-semibold">Rp{{ number_format($mortgageRequest->house_price, 0, '', '.') }}</strong>
                                                  </div>
                                                  <div class="flex items-center justify-between">
                                                      <div class="flex items-center gap-2">
                                                          <img src="{{ asset('assets/images/icons/note.svg') }}"
                                          ...
                                          <section id="KPRPaymentDetails"
                                              ...
                                              <div class="flex flex-col gap-4">
                                                  ...
                                                  <div class="flex items-center justify-between">
                                                      ...
                                                      <strong
                                                          class="font-bold text-[20px] leading-[30px] text-tedja-blue">Rp
                                      ...
                                      <div class="flex flex-col gap-[10px]">
                                          <section id="BankKPRDetails"
                                              ...
                                              <div class="bank flex items-center gap-5">
                                                  <div
                                                      class="w-[99.4px] h-[70px] shrink-0 flex justify-center items-center">
                                                  ...
                                                  <div class="flex flex-col gap-[2px]">
                                                      ...
                                                      <p class="text-sm leading-[21px] text-tedja-secondary">Dipercaya
                                                          jutaan nasabah</p>
                                                  </div>
                                              </div>
                                              <div class="flex flex-col gap-4">
                                                  ...
                                                  <div class="flex flex-col gap-3 rounded-[20px] border border-[#F2F2F4] p-4">
                                                      <div class="flex items-center justify-between">
                                                          <p class="font-semibold">Installment Progress</p>
                                                          <strong class="font-semibold">{{ $paidInstallments }} / {{ $totalInstallments }}</strong>
                                                      </div>
                                                      <div class="w-full overflow-hidden rounded-full bg-[#F2F2F4]" style="height: 12px;">
                                                          <div class="h-full rounded-full bg-tedja-green" style="width: {{ $installmentProgressPercentage }}%;"></div>
                                                      </div>
                                                      <p class="text-sm leading-[21px] text-tedja-secondary">{{ $installmentProgressPercentage }}% of the tenor has been paid.</p>
                                                  </div>
                                          ...
                                          <section id="YouveSubmittedDocuments"
                                              ...
                                              <div class="flex items-center gap-[6px] pl-[7px]">
                                                  <img src="{{ asset('assets/images/icons/security-safe-blue-fill.svg') }}"
                                                      alt="icon" class="size-6 shrink-0">
                                                  <p class="font-semibold">All your privacy data secured with our system
                                                  </p>
                                              </div>
                                          </section>
                                      </div>
                              ...
                              <section id="ContainerInstallments" class="pr-5">
                                  @if ($mortgageRequest->isPaidOff())
                                      <section id="PaidOff" class="py-[40px] flex justify-center">
                                          <div class="flex flex-col gap-5 w-[460px] mx-auto">
                                              <div class="flex flex-col gap-[12px]">
                                                  <h4 class="font-bold text-xl leading-[30px] text-center">Paid Off</h4>
                                                  <p class="leading-7 text-center">Seluruh cicilan KPR untuk rumah ini sudah selesai dibayarkan.</p>
                                              </div>
                                          </div>
                                      </section>
                                  @elseif ($mortgageRequest->status !== 'Approved')
                                  ...
                                  @else
                                      <section id="Available" class="flex flex-col gap-5">
                                          <div class="flex items-center justify-between">
                                              ...
                                              @unless ($mortgageRequest->isPaidOff())
                                          ...
                                          <div class="flex flex-col gap-5">
                                              @forelse ($mortgageRequest->installments as $installment)
                                                  <div
                                                      ...
                                                      <a href="{{ route('dashboard.mortgage.details', $installment) }}" class="shrink-0">
                                                          <div
